    ...
    "nodes": [
        {
            "name": "start",
            "instructions": [
                {"type": "Line", "character": "npc", "text": "Welcome!"},
                {"type": "Choice", "text": "Fight", "target_node": "battle"},
                {"type": "Choice", "text": "Talk", "target_node": "dialogue"}
            ]
        }
    ]
}
